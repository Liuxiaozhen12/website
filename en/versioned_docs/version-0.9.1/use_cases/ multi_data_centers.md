...
Chaos Mesh provides [`NetworkChaos`](../user_guides/network_chaos.md) to inject network latency, so we can use it to simulate the latency between three data centers.
